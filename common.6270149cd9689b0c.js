...
`;var V=e(54438),U=e(95416),J=e(59640);let m=(()=>{class a{constructor(b,O,I){this.apolloProvider=b,this._snackBar=O,this.store=I,this._apollo=this.apolloProvider.use("BALANC")}createVoucher(b){return this.store.select(h.gQ).pipe((0,t.s)(1),(0,c.n)(O=>this._apollo.mutate({mutation:R,variables:{createVoucherInput:b},errorPolicy:"all"}).pipe((0,s.M)(({errors:I,data:d})=>{if(I){let P="";I.forEach(v=>P+=`\n ${v.message}.`),this._snackBar.openFromComponent(M.p,{panelClass:["p-0","bg-transparent"],horizontalPosition:"end",verticalPosition:"bottom",duration:1e4,data:{message:P,title:"Error",type:"error",svgIcon:"mat_solid:error"}})}const T=structuredClone(O);T.push(d.createVoucher.voucher),this.store.dispatch((0,l._6)({vouchers:T}))}))))}getVouchers(){return this._apollo.query({query:$,errorPolicy:"all"}).pipe((0,s.M)(({errors:b,data:O})=>{if(b){let I="";b.forEach(d=>I+=`\n ${d.message}.`),this._snackBar.openFromComponent(M.p,{panelClass:["p-0","bg-transparent"],horizontalPosition:"end",verticalPosition:"bottom",duration:1e4,data:{message:I,title:"Error",type:"error",svgIcon:"mat_solid:error"}})}this.store.dispatch((0,l._6)({vouchers:O.findAllVouchers.vouchers})),this.store.dispatch((0,r.Bp)({pagination:O.findAllVouchers.pagination}))}))}getVoucherById(b){return this._apollo.query({query:D,variables:{findVoucherByIdId:b},errorPolicy:"all"}).pipe((0,s.M)(({errors:O,data:I})=>{if(O){let d="";O.forEach(T=>d+=`\n ${T.message}.`),this._snackBar.openFromComponent(M.p,{panelClass:["p-0","bg-transparent"],horizontalPosition:"end",verticalPosition:"bottom",duration:1e4,data:{message:d,title:"Error",type:"error",svgIcon:"mat_solid:error"}})}this.store.dispatch((0,l.FN)({voucher:I.findOneVoucherById.voucher}))}))}updateVoucher(b){return this.store.select(h.gQ).pipe((0,t.s)(1),(0,c.n)(O=>this._apollo.mutate({mutation:p,variables:{updateVoucherInput:b},errorPolicy:"all"}).pipe((0,s.M)(({errors:I,data:d})=>{if(I){let v="";I.forEach(_=>v+=`\n ${_.message}.`),this._snackBar.openFromComponent(M.p,{panelClass:["p-0","bg-transparent"],horizontalPosition:"end",verticalPosition:"bottom",duration:1e4,data:{message:v,title:"Error",type:"error",svgIcon:"mat_solid:error"}})}const T=structuredClone(O);T[O.findIndex(v=>v.id===b.id)]=d.updateVoucher.voucher,this.store.dispatch((0,l._6)({vouchers:T}))}))))}updateVoucherStatus(b){return this.store.select(h.gQ).pipe((0,t.s)(1),(0,c.n)(O=>this._apollo.mutate({mutation:k,variables:{updateEntityStatusInput:b},errorPolicy:"all"}).pipe((0,s.M)(({errors:I})=>{if(I){let P="";I.forEach(v=>P+=`\n ${v.message}.`),this._snackBar.openFromComponent(M.p,{panelClass:["p-0","bg-transparent"],horizontalPosition:"end",verticalPosition:"bottom",duration:1e4,data:{message:P,title:"Error",type:"error",svgIcon:"mat_solid:error"}})}const d=structuredClone(O);d[O.findIndex(P=>P.id===b.id)].active=b.active,this.store.dispatch((0,l._6)({vouchers:d}))}))))}removeVoucher(b){return this.store.select(h.gQ).pipe((0,t.s)(1),(0,c.n)(O=>this._apollo.mutate({mutation:F,variables:{removeVoucherId:b},errorPolicy:"all"}).pipe((0,s.M)(({errors:I})=>{if(I){let P="";I.forEach(v=>P+=`\n ${v.message}.`),this._snackBar.openFromComponent(M.p,{panelClass:["p-0","bg-transparent"],horizontalPosition:"end",verticalPosition:"bottom",duration:1e4,data:{message:P,title:"Error",type:"error",svgIcon:"mat_solid:error"}})}const d=structuredClone(O),T=O.findIndex(P=>P.id===b);d.splice(T,1),this.store.dispatch((0,l._6)({vouchers:d}))}))))}static#t=this.\u0275fac=function(O){return new(O||a)(V.KVO(S.Ic),V.KVO(U.UG),V.KVO(J.il))};static#e=this.\u0275prov=V.jDH({token:a,factory:a.\u0275fac,providedIn:"root"})}return a})()},72824:(x,E,e)=>{"use strict";e.d(E,{g:()=>c});var t=e(54438);let c=(()=>{class s{transform(l){if(l)switch(l){case"quarterly":return"Trimestral";case"annually":return"Anual";default:return"Mensual"}return""}static#t=this.\u0275fac=function(h){return new(h||s)};static#e=this.\u0275pipe=t.EJ8({name:"subscriptionTitle",type:s,pure:!0,standalone:!0})}return s})()},34343:(x,E,e)=>{"use strict";e.d(E,{Er:()=>l,PL:()=>r,sB:()=>s});var t=e(59640);const c=h=>h.subscriptions,s=(0,t.Mz)(c,h=>h.subscription),r=(0,t.Mz)(c,h=>h.subscriptions),l=(0,t.Mz)(c,h=>h.subscriptionCardsData)},10729:(x,E,e)=>{"use strict";e.d(E,{k:()=>$});var t=e(21413),c=e(99213),s=e(31849),r=e(54438),l=e(51188),h=e(59640);function M(D,R){if(1&D){const p=r.RV6();r.j41(0,"fuse-card",18),r.bIt("click",function(){const k=r.eBV(p).$implicit,V=r.XpG(2);return r.Njj(V.navigate(k.link))}),r.j41(1,"div",19)(2,"div",20),r.EFF(3),r.k0s(),r.j41(4,"div",21),r.EFF(5),r.k0s()()()}if(2&D){const p=R.$implicit;r.R7$(3),r.JRh(p.title),r.R7$(2),r.JRh(p.subtitle)}}function S(D,R){if(1&D){const p=r.RV6();r.j41(0,"div",0)(1,"div",1)(2,"div",2)(3,"div")(4,"div",3)(5,"div",4)(6,"a",5),r.bIt("click",function(){r.eBV(p);const k=r.XpG();return r.Njj(k.navigate("/desktop"))}),r.EFF(7,"Inicio"),r.k0s()(),r.j41(8,"div",4),r.nrm(9,"mat-icon",6),r.j41(10,"a",7),r.EFF(11),r.k0s()()(),r.j41(12,"div",8)(13,"a",9),r.nrm(14,"mat-icon",6),r.j41(15,"span",10),r.EFF(16,"Regresar"),r.k0s()()()(),r.j41(17,"div",11)(18,"div",12),r.EFF(19),r.k0s()()()(),r.j41(20,"div",13)(21,"div",14)(22,"div",15)(23,"div",16),r.Z7z(24,M,6,2,"fuse-card",17,r.fX1),r.k0s()()()()()}if(2&D){const p=r.XpG();r.R7$(9),r.Y8G("svgIcon","mat_solid:chevron_right"),r.R7$(2),r.JRh(p.fuseNavigation.title),r.R7$(3),r.Y8G("svgIcon","mat_solid:chevron_left"),r.R7$(5),r.SpI(" ",p.fuseNavigation.title," "),r.R7$(5),r.Dyx(p.fuseNavigation.children)}}let $=(()=>{class D{constructor(p,F,k){this._changeDetectorRef=p,this._router=F,this.store=k,this._unsubscribeAll=new t.B}ngOnInit(){}navigate(p){this._router.navigateByUrl(p)}static#t=this.\u0275fac=function(F){return new(F||D)(r.rXU(r.gRc),r.rXU(l.Ix),r.rXU(h.il))};static#e=this.\u0275cmp=r.VBU({type:D,selectors:[["ath-content-menu"]],standalone:!0,features:[r.aNF],decls:1,vars:1,consts:[["cdkScrollable","",1,"absolute","inset-0","flex","flex-col","min-w-0","overflow-y-auto"],[1,"flex","flex-col","flex-wrap","p-6","py-3","sm:flex-row","flex-0","sm:items-center","sm:justify-between","sm:pt-12","sm:px-10","bg-default","dark:bg-transparent"],[1,"flex-1","min-w-0"],[1,"flex-wrap","items-center","hidden","font-medium","sm:flex"],[1,"flex","items-center","ml-1","whitespace-nowrap"],[1,"ml-1","cursor-pointer","text-primary-500","hover:underline",3,"click"],[1,"icon-size-5","text-secondary",3,"svgIcon"],[1,"ml-1","text-primary-500"],[1,"flex","sm:hidden"],["routerLink","/desktop",1,"inline-flex","items-center","-ml-1.5","text-secondary","font-medium"],[1,"ml-1"],[1,"mt-2"],[1,"mt-2","text-2xl","font-extrabold","leading-tight","tracking-tight","sm:text-2xl"],[1,"flex-auto","p-6","pt-0","sm:pt-0","sm:p-10"],[1,"flex","flex-col","flex-auto","min-w-0"],[1,"flex","flex-col","w-full"],[1,"grid","grid-flow-row","grid-cols-1","mt-8","sm:grid-cols-2","lg:grid-cols-4","gap-y-12","sm:gap-x-4"],[1,"flex","items-center","justify-between","w-full","p-6","cursor-pointer","max-w-80","filter-info","hover:shadow-md"],[1,"flex","items-center","justify-between","w-full","p-6","cursor-pointer","max-w-80","filter-info","hover:shadow-md",3,"click"],[1,"flex","flex-col"],[1,"text-2xl","font-semibold","leading-tight"],[1,"text-md","text-secondary"]],template:function(F,k){1&F&&r.DNE(0,S,26,4,"div",0),2&F&&r.vxM(0,k.fuseNavigation?0:-1)},dependencies:[c.m_,c.An,s.$],encapsulation:2,changeDetection:0})}return D})()},46812:(x,E,e)=>{"use strict";e.d(E,{H_:()=>r,dX:()=>t});var t=function(p){return p.pendiente="pendiente",p.parcial="parcial",p.pagada="pagada",p.cancelado="cancelado",p.fallido="fallido",p.expirado="expirado",p.devuelto="devuelto",p.dPendiente="devoluci\xf3n pendiente",p.dFallida="devoluci\xf3n fallida",p}(t||{}),r=function(p){return p.total="total",p.partial="partial",p}(r||{})},21607:(x,E,e)=>{"use strict";e.d(E,{At:()=>r,G0:()=>h,ih:()=>l,tz:()=>s});class s{constructor(S,$,D,R,p,F){this.productId=S,this.name=$,this.uom=D,this.price=R,this.quantity=p,this.depotId=F}}class r{constructor(S,$,D){this.assistanceId=S,this.price=$,this.quantity=D}}var l=function(M){return M.nueva="nueva",M.recibida="recibida",M.cobrada="cobrada",M.rechazada="rechazada",M.cancelada="cancelada",M.facturada="facturada",M.entregada="entregada",M}(l||{});class h{constructor(S,$,D,R){this.nueva=S,this.recibida=$,this.rechazada=D,this.cancelada=R}}},41791:(x,E,e)=>{"use strict";e.d(E,{Nh:()=>r,oy:()=>s});var t=e(59640);const c=h=>h.gModules,s=(0,t.Mz)(c,h=>h.module),r=(0,t.Mz)(c,h=>h.modules);(0,t.Mz)(c,h=>({}))},71411:(x,E,e)=>{"use strict";e.d(E,{Q:()=>s});var t=e(54438),c=e(25910);let s=(()=>{class r{constructor(h){this._ratesService=h}resolve(h,M){return this._ratesService.getRates()}static#t=this.\u0275fac=function(M){return new(M||r)(t.KVO(c.f))};static#e=this.\u0275prov=t.jDH({token:r,factory:r.\u0275fac,providedIn:"root"})}return r})()},72831:(x,E,e)=>{"use strict";e.d(E,{Ad:()=>h,NH:()=>M,ed:()=>S});var t=e(18810),c=e(99437),s=e(54438),r=e(44312),l=e(51188);let h=(()=>{class ${constructor(R,p){this._rolesService=R,this._router=p}resolve(R,p){return this._rolesService.findAllRoles().pipe((0,c.W)(F=>this._router.navigateByUrl("/desktop")))}static#t=this.\u0275fac=function(p){return new(p||$)(s.KVO(r.W),s.KVO(l.Ix))};static#e=this.\u0275prov=s.jDH({token:$,factory:$.\u0275fac,providedIn:"root"})}return $})(),M=(()=>{class ${constructor(R,p){this._rolesService=R,this._router=p}resolve(R,p){const F=R.params.roleId;return"new"===F?null:this._rolesService.findRoleById(F).pipe((0,c.W)(k=>{const V=p.url.split("/").slice(0,-1).join("/");return this._router.navigateByUrl(V),(0,t.$)(k)}))}static#t=this.\u0275fac=function(p){return new(p||$)(s.KVO(r.W),s.KVO(l.Ix))};static#e=this.\u0275prov=s.jDH({token:$,factory:$.\u0275fac,providedIn:"root"})}return $})(),S=(()=>{class ${constructor(R,p){this._rolesService=R,this._router=p}resolve(R,p){return this._rolesService.findAllActiveRoles().pipe((0,c.W)(F=>this._router.navigateByUrl("/desktop")))}static#t=this.\u0275fac=function(p){return new(p||$)(s.KVO(r.W),s.KVO(l.Ix))};static#e=this.\u0275prov=s.jDH({token:$,factory:$.\u0275fac,providedIn:"root"})}return $})()},15887:(x,E,e)=>{"use strict";e.d(E,{X7:()=>s,y3:()=>r});var t=e(59640);const c=l=>l.roles,s=(0,t.Mz)(c,l=>l.role),r=(0,t.Mz)(c,l=>l.roles)},44312:(x,E,e)=>{"use strict";e.d(E,{W:()=>V});var t=e(54438),c=e(96354),s=e(88141),r=e(73512),l=e(59640),h=e(49238),M=e(98216);const S=r.J1`
