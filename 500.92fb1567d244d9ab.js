"use strict";(self.webpackChunkatherp=self.webpackChunkatherp||[]).push([[500],{97500:(bi,he,d)=>{d.r(he),d.d(he,{WorkshopModule:()=>xi});var y=d(35357),Qe=d(17460),e=d(5e3),Je=d(35265);let Ve=(()=>{class o{}return o.\u0275fac=function(t){return new(t||o)},o.\u0275cmp=e.Xpm({type:o,selectors:[["app-workshop"]],decls:1,vars:0,template:function(t,r){1&t&&e._UZ(0,"ath-content-menu")},dependencies:[Je.p],encapsulation:2}),o})();var c=d(93075),O=d(86087),Z=d(84847),H=d(39646),F=d(77579),G=d(56451),m=d(82722),v=d(63900),A=d(54004),x=d(85094);const ge=o=>o.workshops,R=((0,x.P1)(ge,o=>o.workshop),(0,x.P1)(ge,o=>o.workshops));var j=d(86428),S=d(48966),fe=d(89116),u=d(59784),k=d(95698),_=d(18505),I=d(17489),Q=d(31982),J=d(75714),h=d(33921);const Le=h.Ps`
